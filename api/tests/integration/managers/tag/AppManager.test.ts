...
import AppRepo from '../../../../src/mongo/repos/tag/AppRepo';
...
describe('AppManager', () => {
    ...
    it('fetches a single app', async () => {
        ManagerTestUtils.mockOrgUserWithViewAccess();

        const mockSutModel = TestUtils.buildMockApp();
        const mockSutRepo = {} as AppRepo;
        ...
        const Q = `
            query {
                getApp(id: "5edf4c48e9615d9a1c66bc2a") {
                    id
                    name
                }
            }
