...
export interface NavPlatform_getPlatform_tag_manager_account_org {
   ...
   */
  tag_manager_account: NavPlatform_getPlatform_tag_manager_account_org_tag_manager_account | null;
  /**
   ...
   */
  data_manager_account: NavPlatform_getPlatform_tag_manager_account_org_data_manager_account | null;
  /**
