...
export interface NavGlobalTrigger_getTrigger_revision_app_tag_manager_account_org {
   ...
   */
  tag_manager_account: NavGlobalTrigger_getTrigger_revision_app_tag_manager_account_org_tag_manager_account;
  /**
   ...
   * been subscribed to.
   */
  data_manager_account: NavGlobalTrigger_getTrigger_revision_app_tag_manager_account_org_data_manager_account;
  /**
