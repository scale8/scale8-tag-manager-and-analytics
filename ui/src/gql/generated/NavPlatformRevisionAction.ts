...
export interface NavPlatformRevisionAction_getPlatformAction_platform_revision_platform_tag_manager_account_org {
   ...
   */
  tag_manager_account: NavPlatformRevisionAction_getPlatformAction_platform_revision_platform_tag_manager_account_org_tag_manager_account;
  /**
   ...
   * been subscribed to.
   */
  data_manager_account: NavPlatformRevisionAction_getPlatformAction_platform_revision_platform_tag_manager_account_org_data_manager_account;
  /**
